...
<% 
	...
	if(comment.trim().equals("")||email.trim().equals("")) { 
		...
		try {
			...
			int i= pstmt.executeUpdate(); // 결과는 숫자로 1일 때 정상
			
			pstmt= conn.prepareStatement("SELECT * FROM comment ORDER BY id DESC");	// 최근에 단 댓글이 맨 위로
